...
WumpusWorld::WumpusWorld (int size)
{
	...
	currentState.goldLocation = Location (3, 3);

	currentState.pitLocations.push_back (Location (2, 3));
	currentState.pitLocations.push_back (Location (2, 4));
	currentState.pitLocations.push_back (Location (3, 2));
	currentState.pitLocations.push_back (Location (4, 2));
